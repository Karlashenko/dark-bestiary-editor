    ...
    export default {
        ...
        methods: {
            ...
            reset: function (category) {
                ...
                window.axios.get('/frontend/talent_categories/' + category.id).then(response => {
            ...
            save: function (category) {
                ...
                if (category.fresh) {
                    window.axios.post('/frontend/talent_categories', category).then(response => {
                        this.categories[index] = response.data;
                        this.select(this.categories[index]);
                    });
                ...
                window.axios.put('/frontend/talent_categories/' + category.id, category).then(response => {
                    this.categories[index] = response.data;
                    this.select(this.categories[index]);
                });
            },
            ...
            destroy: function (category) {
                ...
                window.axios.delete('/frontend/talent_categories/' + category.id).then(() => {
                    this.categories.splice(index, 1);
                    this.select(this.categories[index <= 0 ? 0 : index - 1]);
                });
            },
