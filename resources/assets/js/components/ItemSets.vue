<template>
    <div>
        <div>
            <div class="row">
                <div class="col-md-3">
                    <list :elements="sets" :fields="['id', 'name_i18n.en']" v-model="selected"></list>
                </div>
                                    ...
                                    <td>
                                        <table style="width: 100%">
                                            ...
                                            <tr v-for="behaviour in selected.behaviours">
                                                ...
                                                <td>
                                                    <input type="number" class="form-control" v-model="behaviour.pivot.item_count">
                                                </td>
    ...
    export default {
        ...
        methods: {
            ...
            reset: function (type) {
                ...
                window.axios.get('/frontend/item_sets/' + type.id).then(response => {
            ...
            save: function (type) {
                ...
                if (type.fresh) {
                    window.axios.post('/frontend/item_sets', type).then(response => {
                        this.sets[index] = response.data;
                        this.select(this.sets[index]);
                    });
                ...
                window.axios.put('/frontend/item_sets/' + type.id, type).then(response => {
                    this.sets[index] = response.data;
                    this.select(this.sets[index]);
                });
            },
            ...
            destroy: function (type) {
                ...
                window.axios.delete('/frontend/item_sets/' + type.id).then(() => {
                    this.sets.splice(index, 1);
                    this.select(this.sets[index <= 0 ? 0 : index - 1]);
                });
            },
